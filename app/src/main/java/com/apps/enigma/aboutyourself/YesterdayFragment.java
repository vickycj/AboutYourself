 ...
 */
public class YesterdayFragment extends Fragment implements AsyncTaskPass {
...
Context context;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
      ...
      View rootView=inflater.inflate(R.layout.yesterday_layout,container,false);
    ...
    public void loadUsageData(Map<String, UsageStats> map) {
        ...
        double percent=GeneralUtils.calculatePercent(calculateTotalTime,GeneralUtils.ONE_WEEK_MILLIS);
