 ...
 */
public class TomorrowFragment extends Fragment implements AsyncTaskPass {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView=inflater.inflate(R.layout.tomorrow_layout,container,false);
    ...
    public void loadUsageData(Map<String, UsageStats> map) {
        ...
        double percent=GeneralUtils.calculatePercent(calculateTotalTime,GeneralUtils.ONE_MONTH_MILLIS);
